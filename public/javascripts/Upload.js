...
{
  var xhr = new XMLHttpRequest();
  xhr.open('GET', 'sign?name=' + file.name + '&type=' + file.type, true);
...
function setProgress(percent, statusLabel)
{
  ...
  document.getElementById('progress_bar').className = 'loading progress progress-warning progress-striped active';
 
  document.getElementById('status').innerText = statusLabel+"             "+fileNumber+" / "+fileTotal;
}